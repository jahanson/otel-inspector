...
class AnyValue$Type extends MessageType<AnyValue> {
  ...
  override create(value?: PartialMessage<AnyValue>): AnyValue {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* opentelemetry.proto.common.v1.KeyValueList kvlist_value */ 6:
          message.value = {
            oneofKind: "kvlistValue",
            kvlistValue: KeyValueList.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.value as any).kvlistValue,
            ),
          };
          break;
  ...
  override internalBinaryWrite(message: AnyValue, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    ...
    if (message.value.oneofKind === "arrayValue") {
      ArrayValue.internalBinaryWrite(message.value.arrayValue, writer.tag(5, WireType.LengthDelimited).fork(), options)
        .join();
    }
    /* opentelemetry.proto.common.v1.KeyValueList kvlist_value = 6; */
    if (message.value.oneofKind === "kvlistValue") {
      KeyValueList.internalBinaryWrite(
...
class ArrayValue$Type extends MessageType<ArrayValue> {
  constructor() {
    super("opentelemetry.proto.common.v1.ArrayValue", [
      { no: 1, name: "values", kind: "message", repeat: 2, /*RepeatType.UNPACKED*/ T: () => AnyValue },
    ]);
  }
  override create(value?: PartialMessage<ArrayValue>): ArrayValue {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.values = [];
    if (value !== undefined) {
  ...
  override internalBinaryWrite(message: ArrayValue, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
...
class KeyValueList$Type extends MessageType<KeyValueList> {
  constructor() {
    super("opentelemetry.proto.common.v1.KeyValueList", [
      { no: 1, name: "values", kind: "message", repeat: 2, /*RepeatType.UNPACKED*/ T: () => KeyValue },
    ]);
  }
  override create(value?: PartialMessage<KeyValueList>): KeyValueList {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.values = [];
    if (value !== undefined) {
...
class KeyValue$Type extends MessageType<KeyValue> {
  ...
  override create(value?: PartialMessage<KeyValue>): KeyValue {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.key = "";
    if (value !== undefined) {
  ...
  override internalBinaryWrite(message: KeyValue, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
    /* string key = 1; */
    if (message.key !== "") {
...
class InstrumentationScope$Type extends MessageType<InstrumentationScope> {
  constructor() {
    super("opentelemetry.proto.common.v1.InstrumentationScope", [
      ...
      { no: 3, name: "attributes", kind: "message", repeat: 2, /*RepeatType.UNPACKED*/ T: () => KeyValue },
      { no: 4, name: "dropped_attributes_count", kind: "scalar", T: 13 /*ScalarType.UINT32*/ },
    ]);
  }
  override create(value?: PartialMessage<InstrumentationScope>): InstrumentationScope {
    const message = globalThis.Object.create(this.messagePrototype!);
    message.name = "";
    message.version = "";
    message.attributes = [];
  ...
  override internalBinaryWrite(
    ...
    for (let i = 0; i < message.attributes.length; i++) {
      KeyValue.internalBinaryWrite(message.attributes[i], writer.tag(3, WireType.LengthDelimited).fork(), options)
        .join();
    }
