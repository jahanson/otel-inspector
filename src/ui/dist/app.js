...
function Tabs({ value, onValueChange, values }) {
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "ui-tabs", role: "tablist", "aria-label": "Dashboard views", children: values.map((item) => /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
    "button",
    {
      role: "tab",
      type: "button",
...
function App() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("main", { className: "workbench", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("section", { className: "workbench__body", id: `panel-${activeTab}`, role: "tabpanel", children: [
      activeTab === "overview" ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(OverviewCards, { cards: projection.cards }) : /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("p", { className: "empty-state", children: "This dashboard tab is not implemented yet." }),
