...
function Badge({ className = "", ...props }) {
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: `ui-badge ${className}`.trim(), ...props });
}
...
function Button(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { className: `ui-button ${className}`.trim(), ...rest });
}

// src/ui/dashboard/components/ui/card.tsx
var import_jsx_runtime3 = __toESM(require_jsx_runtime());
function Card({ className = "", ...props }) {
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("section", { className: `ui-card ${className}`.trim(), ...props });
}
...
function ChartTooltipContent(props) {
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "chart-tooltip", children: [
    props.label ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "chart-tooltip__label", children: props.label }) : null,
    props.value ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("strong", { children: props.value }) : null
  ] });
}

// src/ui/dashboard/components/ui/tabs.tsx
var import_jsx_runtime5 = __toESM(require_jsx_runtime());
function Tabs({ value, onValueChange, values }) {
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { className: "ui-tabs", role: "tablist", "aria-label": "Dashboard views", children: values.map((item) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
    "button",
    {
      role: "tab",
      type: "button",
...
function App() {
  ...
  const [refreshError, setRefreshError] = (0, import_react.useState)(null);
...
function formatExplorerValue(value, unit) {
  if (value === void 0) {
    return "n/a";
  }
